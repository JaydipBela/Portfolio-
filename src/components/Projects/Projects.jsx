...
import { FiExternalLink, FiGithub, FiChevronRight, FiInfo, FiX } from 'react-icons/fi'
import './Projects.css'
...
const Projects = () => {
  ...
  const projectsData = [
    ...
    },
    {
      id: 2,
      title: 'Weather App',
      description: 'A weather application that displays current conditions and forecasts based on user location or search queries.',
    ...
    },
    {
      id: 5,
      title: 'Todo List',
      description: 'This project is a simple yet functional To-Do List web application that allows users to manage their tasks through a clean interface. Users can add new tasks, edit existing ones, and delete completed items, with all data being saved to the browsers local storage for persistence between sessions. The application features a responsive design with color-coded buttons for different actions and a minimalist layout that focuses on usability.',
...
useEffect(() => {
  ...
  .fromTo('.projects-intro',
    { opacity: 0, y: 20 },
    { opacity: 1, y: 0, duration: 0.5 },
    "-=0.4"
  )
  .fromTo('.project-categories .category-btn',
    { opacity: 0, y: 20, stagger: 0.1 },
    { opacity: 1, y: 0, duration: 0.4, stagger: 0.1 },
    "-=0.3"
  )
  .fromTo('.projects-grid .project-card',
  ...
  <section id="projects" className="projects">
    <div className="container">
          ...
          {filteredProjects.map(project => (
            <div key={project.id} className="project-card ">
              ...
              <div className="project-info">
                <h3>{project.title}</h3>
                <p className="project-description">{project.description.length > 120
      ...
      <div className="more-projects">
        <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="more-link">
